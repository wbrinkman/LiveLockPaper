export const Keys = {
    ...
    LOCKSCREEN_TEXT_CUSTOMIZE_ENABLED: "lockscreen-text-customize-enabled",
    LOCKSCREEN_TEXT_HIDE_CMD: "lockscreen-text-hide-cmd",
    LOCKSCREEN_TEXT_HIDE_TIME: "lockscreen-text-hide-time",
    LOCKSCREEN_TEXT_HIDE_DATE: "lockscreen-text-hide-date",
    LOCKSCREEN_TEXT_HIDE_HINT: "lockscreen-text-hide-hint",
    LOCKSCREEN_TEXT_CMD_SIZE: "lockscreen-text-cmd-size",
    LOCKSCREEN_TEXT_TIME_SIZE: "lockscreen-text-time-size",
    LOCKSCREEN_TEXT_DATE_SIZE: "lockscreen-text-date-size",
    LOCKSCREEN_TEXT_HINT_SIZE: "lockscreen-text-hint-size",
    LOCKSCREEN_TEXT_CMD_COLOR: "lockscreen-text-cmd-color",
    LOCKSCREEN_TEXT_TIME_COLOR: "lockscreen-text-time-color",
    LOCKSCREEN_TEXT_DATE_COLOR: "lockscreen-text-date-color",
    LOCKSCREEN_TEXT_HINT_COLOR: "lockscreen-text-hint-color",
    LOCKSCREEN_TEXT_CMD_FONT: "lockscreen-text-cmd-font",
    LOCKSCREEN_TEXT_TIME_FONT: "lockscreen-text-time-font",
    LOCKSCREEN_TEXT_DATE_FONT: "lockscreen-text-date-font",
    LOCKSCREEN_TEXT_HINT_FONT: "lockscreen-text-hint-font",
    LOCKSCREEN_TEXT_CMD_WEIGHT: "lockscreen-text-cmd-weight",
    LOCKSCREEN_TEXT_TIME_WEIGHT: "lockscreen-text-time-weight",
    LOCKSCREEN_TEXT_DATE_WEIGHT: "lockscreen-text-date-weight",
    LOCKSCREEN_TEXT_HINT_WEIGHT: "lockscreen-text-hint-weight",
    LOCKSCREEN_TEXT_CMD_STYLE: "lockscreen-text-cmd-style",
    LOCKSCREEN_TEXT_TIME_STYLE: "lockscreen-text-time-style",
    LOCKSCREEN_TEXT_DATE_STYLE: "lockscreen-text-date-style",
    LOCKSCREEN_TEXT_HINT_STYLE: "lockscreen-text-hint-style",
    LOCKSCREEN_TEXT_CMD_COMMAND: "lockscreen-text-cmd-command",
    LOCKSCREEN_TEXT_TIME_FORMAT: "lockscreen-text-time-format",
    LOCKSCREEN_TEXT_DATE_FORMAT: "lockscreen-text-date-format",
    LOCKSCREEN_KEEP_AWAKE_ENABLED: "lockscreen-keep-awake-enabled",
    LOCKSCREEN_KEEP_AWAKE_TIMEOUT_SECONDS: "lockscreen-keep-awake-timeout-seconds",
    LOCKSCREEN_KEEP_AWAKE_ONLY_ON_AC: "lockscreen-keep-awake-only-on-ac",
